#!/usr/bin/env python3
"""SABATO 20/06 — Sebastiano a Bolzano alle 15:00 (Il Vascello). Leverage presenza fisica:
...
def build(ts):
    ...
    for t in ts:
        ...
        dvv=r['conversation_initiation_client_data']['dynamic_variables']
        dvv['citta']=t.get('citta','Trento')
        dvv['call_attempt']=t.get('call_attempt','1')
        dvv['prev_note']=t.get('prev_note','')
...
plan=json.load(open('/Users/simocors/Desktop/telesales/sat20_run/plan_20jun.json'))
SCHED=[('09:30','slot_1000'),('11:00','slot_1130'),('14:30','slot_1430'),('16:00','slot_1630')]
log(f"=== SCHEDULER SABATO 20/06 armato (target {TARGET}) ===")
