#!/usr/bin/env python3
"""GIOVEDI 18/06 — Sebastiano a Bolzano alle 15:00 (Il Vascello). Leverage presenza fisica:
...
plan=json.load(open('/Users/simocors/Desktop/telesales/thu18_run/plan_18jun.json'))
SCHED=[('11:00','slot_1100'),('14:30','slot_1430'),('16:30','slot_1630')]
log(f"=== SCHEDULER GIOVEDI 18/06 armato (target {TARGET}) ===")
