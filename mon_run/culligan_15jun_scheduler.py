#!/usr/bin/env python3
"""LUNEDI 15/06 — Sebastiano disponibile zona Bolzano per visite. Leverage presenza fisica:
...
plan=json.load(open('/Users/simocors/Desktop/telesales/mon_run/plan_15jun.json'))
SCHED=[('10:00','slot_1000'),('11:30','slot_1130'),('14:30','slot_1430'),('16:30','slot_1630')]
log(f"=== SCHEDULER LUNEDI 15/06 armato (target {TARGET}) ===")
