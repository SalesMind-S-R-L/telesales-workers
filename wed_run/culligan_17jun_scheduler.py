#!/usr/bin/env python3
"""MERCOLEDI 17/06 — Sebastiano a Bolzano alle 15:00 (Il Vascello). Leverage presenza fisica:
...
def build(ts):
    ...
    for t in ts:
        ...
        r['conversation_initiation_client_data']['dynamic_variables']['citta']=t.get('citta','Trento')
...
plan=json.load(open('/Users/simocors/Desktop/telesales/wed_run/plan_17jun.json'))
SCHED=[('10:00','slot_1000'),('11:30','slot_1130'),('14:30','slot_1430'),('16:30','slot_1630')]
log(f"=== SCHEDULER MERCOLEDI 17/06 armato (target {TARGET}) ===")
