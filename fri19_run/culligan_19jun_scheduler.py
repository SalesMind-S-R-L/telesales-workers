#!/usr/bin/env python3
"""VENERDI 19/06 — Sebastiano a Bolzano alle 15:00 (Il Vascello). Leverage presenza fisica:
...
plan=json.load(open('/Users/simocors/Desktop/telesales/fri19_run/plan_19jun.json'))
SCHED=[('10:00','slot_1000'),('11:30','slot_1130'),('14:30','slot_1430'),('16:30','slot_1630')]
log(f"=== SCHEDULER VENERDI 19/06 armato (target {TARGET}) ===")
